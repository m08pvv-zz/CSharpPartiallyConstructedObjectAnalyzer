namespace SimpleAnalyzer
{
    ...
    {
        public const string ActivityDemo = @"using System.Threading;
...
namespace XamarinDemo
{
                ...
                for (int i = 0; i < 1024; i++)
                {
                    ...
                    Parallel.Invoke(
                        ...
                        () =>
                        {
                            ...
                            try
                            {
                                Monitor.Enter(personLockObject, ref lockTaken);
                                if (person != null)
                                    return;
    ...
    public class Person
    {
        ...
        public const string DictionaryCode = @"// Licensed to the .NET Foundation under one or more agreements.
